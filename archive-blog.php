...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		<div class="container">
            ...
            <?php if( have_rows('blog_categorieen', 2320) ): ?>

                <ul class="list-inline categorie-index">

                <?php while( have_rows('blog_categorieen', 2320) ): the_row(); 

                    // vars
                    $titel = get_sub_field('blog_categorie_titel');
                    $image = get_sub_field('blog_categorie_foto');
                    $link = get_sub_field('blog_categorie_link');
